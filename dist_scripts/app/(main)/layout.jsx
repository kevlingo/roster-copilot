...
export default function MainLayout(_a) {
    var children = _a.children;
    var pathname = usePathname();
    var _b = useState('light'), theme = _b[0], setTheme = _b[1];
    var _c = useState(false), isAIPanelOpen = _c[0], setIsAIPanelOpen = _c[1];
    var _d = useState(false), isAIPanelMinimized = _d[0], setIsAIPanelMinimized = _d[1];
    // Current league ID (would come from state management in a real app)
    var currentLeagueId = 'league-123';
    ...
    return (<div className="flex h-screen">
      ...
      <div className="drawer md:hidden">
        ...
        <div className="drawer-content flex flex-col">
          {/* Page content */}
          <Header username="Fantasy User" onLogout={handleLogout} onToggleTheme={toggleTheme} isDarkTheme={theme === 'dark'}/>
      ...
      {/* AI Copilot Panel */}
      <AIPanel isOpen={isAIPanelOpen} onToggleOpen={function () { return setIsAIPanelOpen(!isAIPanelOpen); }} isMinimized={isAIPanelMinimized} onToggleMinimize={function () { return setIsAIPanelMinimized(!isAIPanelMinimized); }} title={pathname === '/onboarding' ? 'AI Copilot Onboarding' : 'AI Copilot'}>
        {pathname === '/onboarding' ? (<div className="text-center space-y-4">
      ...
      {!isAIPanelOpen && (<button onClick={function () { return setIsAIPanelOpen(true); }} className="fixed bottom-4 right-4 z-30 btn btn-primary btn-circle shadow-lg" aria-label="Open AI Copilot">
