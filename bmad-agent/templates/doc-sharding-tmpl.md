...
- **Target File Pattern:** `docs/shards/epic-<id>.md`
...
- **Target File:** `docs/shards/environment-vars.md`
...
- **Target File:** `docs/shards/project-structure.md`
...
- **Target File:** `docs/shards/tech-stack.md`
...
- **Target File:** `docs/shards/operational-guidelines.md`
...
- **Target File:** `docs/shards/component-view.md`

- **Source Section(s) to Copy:** Section(s) titled "Core Workflow / Sequence Diagrams" (including all sub-diagrams).
- **Target File:** `docs/shards/sequence-diagrams.md`

- **Source Section(s) to Copy:** Section(s) titled "Infrastructure and Deployment Overview".
- **Target File:** `docs/shards/infra-deployment.md`

  - _Agent Note: This is for the broader overview, distinct from the specific `docs/shards/environment-vars.md`._

- **Source Section(s) to Copy:** Section(s) titled "Key Reference Documents".
- **Target File:** `docs/shards/key-references.md`
...
- **Target File:** `docs/shards/front-end-project-structure.md`
...
- **Target File:** `docs/shards/front-end-style-guide.md`
...
- **Target File:** `docs/shards/front-end-component-guide.md`
...
- **Target File:** `docs/shards/front-end-coding-standards.md`
...
- **Target File:** `docs/shards/front-end-state-management.md`

- **Source Section(s) to Copy:** Section(s) titled "API Interaction Layer".
- **Target File:** `docs/shards/front-end-api-interaction.md`

- **Source Section(s) to Copy:** Section(s) titled "Routing Strategy".
- **Target File:** `docs/shards/front-end-routing-strategy.md`

- **Source Section(s) to Copy:** Section(s) titled "Frontend Testing Strategy".
- **Target File:** `docs/shards/front-end-testing-strategy.md`
