...
- Name: League Creation Flow >> back to dashboard link works
- Location: C:\Source\roster-copilot\e2e\league-creation.e2e.spec.ts:47:7
...
Call log:
  - waiting for locator('text=Back to Dashboard')
    - locator resolved to 2 elements. Proceeding with the first one: <a href="/dashboard" class="btn btn-ghost btn-sm">← Back to Dashboard</a>
  - attempting click action
    ...
    at C:\Source\roster-copilot\e2e\league-creation.e2e.spec.ts:52:16
```
