...
-   Refer to UI/UX Design Spec section 2.4.2 (`ChatMessageBubble`), section 2.3 (Visual Design), and 2.6 (Typography) in [`docs/Frontend_Architecture.md`](docs/Frontend_Architecture.md).
