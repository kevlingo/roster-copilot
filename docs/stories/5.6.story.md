...
-   Refer to UI/UX Design Spec section 3.1 (`PersistentChatInterface`) and section 3.2 (State Management), 3.4 (API Integration Conceptual), 3.5 (Performance & Optimization) in [`docs/Frontend_Architecture.md`](docs/Frontend_Architecture.md).
